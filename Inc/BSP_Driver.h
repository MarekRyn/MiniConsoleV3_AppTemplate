...
typedef struct {
	...
	/* 0150 */		void (* G2D_DrawBitmapBlend)(const void * sourcedata, int16_t x, int16_t y, int16_t width, int16_t height, uint8_t alpha);
	/* 0151 */		void (* G2D_DrawBitmapBlendC)(const void * sourcedata, int16_t x, int16_t y, int16_t width, int16_t height, uint8_t alpha);
	/* 0152 */		void (* G2D_DrawBitmap)(const void * sourcedata, int16_t x, int16_t y, int16_t width, int16_t height);
	/* 0153 */		void (* G2D_DrawBitmapC)(const void * sourcedata, int16_t x, int16_t y, int16_t width, int16_t height);
	/* 0154 */		void (* G2D_DrawBitmapRotate)(const void * sourcedata, int16_t x, int16_t y, int16_t width, int16_t height, float angle);
	/* 0155 */		void (* G2D_DrawBitmapRotateC)(const void * sourcedata, int16_t x, int16_t y, int16_t width, int16_t height, float angle);
	/* 0156 */		void (* G2D_DrawIcon)(const void * iconsource, int16_t x, int16_t y, uint32_t color, uint32_t bgcolor);
	/* 0157 */		void (* G2D_DrawIconC)(const void * iconsource, int16_t x, int16_t y, uint32_t color, uint32_t bgcolor);
	/* 0158 */		void (* G2D_DrawIconBlend)(const void * iconsource, int16_t x, int16_t y, uint32_t color);
	/* 0159 */		void (* G2D_DrawIconBlendC)(const void * iconsource, int16_t x, int16_t y, uint32_t color);
	/* 0160 */		uint16_t (* G2D_GetIconHeight)(const void * iconsource);
	/* 0161 */		uint16_t (* G2D_GetIconWidth)(const void * iconsource);
	/* 0162 */		void (* G2D_DrawJPEG)(const void * jpeg_addr, uint32_t jpeg_size, int16_t x, int16_t y);
	/* 0163 */		void (* G2D_DrawJPEGC)(const void * jpeg_addr, uint32_t jpeg_size, int16_t x, int16_t y);
	/* 0164 */		void (* G2D_DrawLastJPEG)(int16_t x, int16_t y);
	/* 0165 */		void (* G2D_DrawLastJPEGC)(int16_t x, int16_t y);
	/* 0166 */		void (* G2D_DecodeJPEG)(const void * jpeg_addr, uint32_t jpeg_size);
	/* 0167 */		uint32_t *	reserved0167;
	/* 0168 */		uint32_t *	reserved0168;
	/* 0169 */		uint32_t *	reserved0169;
	/* 0170 */		uint32_t *	reserved0170;
	/* 0171 */		uint32_t (* G2D_Color)(uint32_t color, uint8_t alpha);
	/* 0172 */		uint32_t (* G2D_Alpha)(uint32_t color, uint8_t alpha);
	/* 0173 */		void (* G2D_CopyBuf)(const void * src_addr, uint16_t offsline_src, uint16_t x_dest, uint16_t y_dest, uint16_t width, uint16_t height);
	/* 0174 */		void (* G2D_CopyBufBlend)(const void * src_addr, uint16_t offsline_src, uint16_t x_dest, uint16_t y_dest, uint16_t width, uint16_t height, uint8_t alpha);
